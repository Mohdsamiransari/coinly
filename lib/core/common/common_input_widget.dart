...
class CommonInputWidget extends StatefulWidget {
  ...
  final bool? isPrefixBoxConstraints;
  final bool? isSuffixBoxConstraints;
  ...
  const CommonInputWidget({
    ...
    this.isPrefixBoxConstraints = true,
    this.isSuffixBoxConstraints = true,
  });
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: InputDecoration(
        ...
        prefixIconConstraints: widget.isPrefixBoxConstraints == false
            ? null
            : BoxConstraints(
                maxWidth: 45.r,
                maxHeight: 20.r,
        ...
        suffixIconConstraints: widget.isSuffixBoxConstraints == false
            ? null
            : BoxConstraints(
                maxWidth: 34.r,
                maxHeight: 20.r,
